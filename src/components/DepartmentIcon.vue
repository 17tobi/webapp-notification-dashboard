<template>
    <svg v-if="department === departments.DEVOPS" :class="eventDepartmentLower" version="1.1" id="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    ...
    <svg v-else-if="department === departments.IBMI" :class="eventDepartmentLower" id="icon" xmlns="http://www.w3.org/2000/svg" :width="54 + 'px'" :height="54 + 'px'" viewBox="0 0 32 32">
    ...
    <svg v-else-if="department === departments.SOLUTIONS" :class="eventDepartmentLower" :width="54 + 'px'" :height="54 + 'px'" id="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    ...
    <svg v-else-if="department === departments.SWE" :class="eventDepartmentLower" :width="54 + 'px'" :height="54 + 'px'" id="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
